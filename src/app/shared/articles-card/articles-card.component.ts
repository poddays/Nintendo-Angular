  ...
  constructor() { 
    this.newsCard = [
      ...
      },
      {
        ...
        date : new Date(2022,2,22),
        titolo : 'Experience the fight to save humanity from 13 different perspectives in 13 Sentinels: Aegis Rim',
        readMore: "Read More",
      },
      {
      ...
      {
        image : "https://assets.nintendo.com/image/upload/f_auto/q_auto/dpr_auto/c_scale,w_800/v1/ncom/en_US/articles/2022/grab-a-friend-and-try-to-survive-in-don-t-starve-together/1920x1080_News_DST?_a=ATAK9AA0",
        date : new Date(2022,11,4),
        titolo : 'Grab a friend and try to survive in Don’t Starve Together',
        readMore: "Read More",
      },
    ],
    //News in evidenza
    this.newsCardEvidence = [
      {
